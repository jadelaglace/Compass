...
import { ref } from 'vue'
import { useInsightsStore, type Insight } from '@/stores/insights'
...
function handleSave(data: { content: string; maturity: import('@/stores/insights').Maturity; entity_title: string; entity_id: string }) {
